  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('EquipmentIssuing').doc('TT')
            .collection('Equipment').snapshots(),
        builder: (ctx, equimentSnapshot){
          ...
          return ListView.builder(
            ...
            itemCount: reqMembers.length,
              itemBuilder: (ctx, index)=>reqMembers[index]['isRequested']? RequestWidget(
                requested: reqMembers[index]['isRequested'],
...
class RequestWidget extends StatefulWidget {
  ...
  RequestWidget({required this.requested,required this.name,
    ...
    return onp?GestureDetector(
      ...
      onTap: (){
        showDialog(
            context: context,
            builder: (context) {
              return PopUpRequest(onTap: ()async{
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(widget.misId,style: const TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(widget.tableNumber,style: const TextStyle(
                        color: Colors.black,
                        fontSize: 17,
                        fontWeight: FontWeight.w600,
                      ),)
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Text('Number of Racket :-',style: TextStyle(
                        color: Colors.black,
                        fontSize: 17,
                        fontWeight: FontWeight.w600,
                      ),),
                      const SizedBox(width: 5,),
                      Text(widget.racketNumber.toString(),
                ...
                Row(
                  children: [
                    const Text('Issuing Time',style: TextStyle(
                      color: Colors.black,
                      fontSize: 17,
                      fontWeight: FontWeight.w600,
                    ),),
                    const SizedBox(width: 8,),
                    Text(minute<10?'$hour:0$minute $gb':
                    '$hour:$minute $gb',style: const TextStyle(
                      color: Colors.black,
                      fontSize: 15,
                      fontWeight: FontWeight.w600
                    ),),
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: const Icon(Icons.cancel,size: 40,color: Colors.white),
                )
              ],
            )
          ],
